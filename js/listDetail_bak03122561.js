$(function(){
                ...
                $.each(rep,function(keys,values){
                    ...
                    if(values['cancel_remark'] !="" && values['cancel_remark'] !=null){
                        ...
                        var return_comment = " ";
                            ...
                            listPR += "<a href='report/pr/report_pr.php?pr_id="+values['pr_id']+"' class='list-group-item list-group-item-action flex-column align-items-start'>";
        ...
        if(statusApprove == "ISD"){
             ...
             $.getJSON('api/controller/isd.php?status=Read',function(rep){
                ...
                $.each(rep,function(keys,values){
                    ...
                    listISD += "<a href='report/isd/report_isd.php?FRequestID="+values['FRequestID']+"' class='list-group-item list-group-item-action flex-column align-items-start'>";
        ...
        if(statusApprove == "PO"){
            ...
            $.getJSON('api/controller/po.php?status=Read',function(rep){
               ...
               $.each(rep,function(keys,values){
                   ...
                   listPO += "<a href='report/po/report_po.php?po_id="+values['po_id']+"' class='list-group-item list-group-item-action flex-column align-items-start'>";
                        listPO += "<div class='d-flex w-100 justify-content-between'>";
                        listPO += "<h5 class='mb-1'>PO: "+ values['code_full']+"</h5>";
                        listPO += "<small> วันที่ร้องขอ "+ formatDate(values['po_create_date']) +"</small>";
                        listPO += "</div>";
                        listPO += "<p class='mb-1'>"+ values['po_remark'] +"</p>";
                        listPO += "<small >"+values['comp_name'] +"</small> <br/>";
	   ...
	   if(statusApprove == "CM"){
             ...
             $.getJSON('api/controller/cm.php?status=Read',function(rep){
                ...
                $.each(rep,function(keys,values){
                    //console.log(values);
                    listCM += "<a href='report/cm/report_cm.php?FRequestID="+values['FRequestID']+"' class='list-group-item list-group-item-action flex-column align-items-start'>";
                        ...
                        listCM += "<small class='text-justify'>"+values['brn_name']+"</small>";
		...
		if(statusApprove == "MT"){
             ...
             $.getJSON('api/controller/mt.php?status=Read',function(rep){
                ...
                $.each(rep,function(keys,values){
                   // console.log(values);
                    listMT += "<a href='report/mt/report_mt.php?FRequestID="+values['FRequestID']+"' class='list-group-item list-group-item-action flex-column align-items-start'>";
